...
public class WeaponManagerUI : MonoBehaviour {
    ...
    [Space]
    [Tooltip("El arma exacta que aparecer� en pantalla")] public WeaponSystem weapon;
    ...
    [Range(0, 0.3f), Tooltip("Tiempo muerto desde la aparici�n hasta que puedas moverte")] public float deadTime;
