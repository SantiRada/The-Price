...
public class CameraMovement : MonoBehaviour {
    ...
    [Header("Sizing")]
    private static float _newPerspective;
    ...
    public static void SetSize(SizeCamera type)
    {
        ...
        switch (type)
        {
            case SizeCamera.specific: _newPerspective = 7f; break;
            case SizeCamera.normal: _newPerspective = 9.5f; break;
            case SizeCamera.boss: _boss = FindAnyObjectByType<BossSystem>(); break;
        }
    }
    public static void CancelSize() { _newPerspective = 9.5f; }
